...
其实实验二我早就已经完成了，但是最近实在没有时间，所以今天才更新博客
我是第一个验收实验二的，允许验收实验二的第一堂课我就去验收了，最后也是**拿到了最高评级 A+** （这里还是要吐槽一句为什么最高评级都只有 95 ，就不能给 100 吗 ）
...
其他还有很多小功能，可以访问[我的后台管理系统](http://120.25.234.241:8080/admin)来体验，也可以 clone 我的 [GitHub 项目](https://github.com/tjbnbb/LAB1_2)在本地运行，觉得还行的话欢迎 star 和 fork
## 实验内容
